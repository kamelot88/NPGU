...
const arrowBurger1 = document.querySelector("#head > div.burger > div > svg:nth-child(1)");
const arrowBurger2 = document.querySelector("#head > div.burger > div > svg:nth-child(3)");
...
imagePrewKab.innerHTML = colectionImagePrewSlav[0].innerHTML;
